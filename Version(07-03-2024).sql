...
-- Volcando datos para la tabla adminmuebles.comision_propietario: 18 rows
...
-- Volcando datos para la tabla adminmuebles.inmueble: 24 rows
...
INSERT INTO `inmueble` (`IdInmueble`, `IdPropietario`, `NoMatricula`, `Direccion`, `Estrato`, `Ciudad`, `Barrio`, `Tipo`, `NoNiveles`, `NoBanos`, `ServiciosPublicos`, `NoHabitaciones`, `Estado`, `NoTerraza`, `AreaConstruidaM2`, `Aseguramiento`, `ValorInmueble`, `booleanos`, `Descripcion`) VALUES
	...
	(9, NULL, 1, 'kjlkjl', '1', 'kkjl', 'jhkjhk', 'Oficina', NULL, '2', 'cgkjkj', NULL, 'Disponible', NULL, NULL, '2024-03-01', 2000, 'true', 'uiuku'),
...
-- Volcando datos para la tabla adminmuebles.pagos_arrendamiento: 30 rows
