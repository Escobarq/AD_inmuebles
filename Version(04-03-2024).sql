...
-- Volcando datos para la tabla adminmuebles.comision_propietario: 3 rows
/*!40000 ALTER TABLE `comision_propietario` DISABLE KEYS */;
INSERT INTO `comision_propietario` (`IdComisionPropietario`, `IdPropietario`, `IdInmueble`, `FechaElaboracion`, `PeriodoPagado`, `ElaboradoPor`, `FormaPago`, `PagoArriendo`, `AdmInmobi`, `AseoEntrega`, `Mantenimiento`) VALUES
	(3, 11, 25, NULL, '2024-03-04', 'Juan Pérez', 'Efectivo', 250000, 120, 300, 5000),
	(4, 11, 20, NULL, '2024-03-04', 'Juan Pérez', 'Transferencia', 50000000, 30, 20, 3000),
	(5, 12, 26, NULL, '2024-03-27', 'Juan Pérez', 'Efectivo', 2000, 400, 20, 0);
...
INSERT INTO `propietario` (`IdPropietario`, `NombreCompleto`, `TipoDocumento`, `DocumentoIdentidad`, `Direccion`, `Telefono`, `Correo`, `Banco`, `TipoCuenta`, `NumeroCuenta`, `booleanos`, `FechaIngreso`) VALUES
	...
	(18, 'Prueba', 'Pasaporte', '659856', 'nose por palmira', '', '', 'av villa', 'Cuenta Ahorros', '25364558', 'true', NULL);
