...
-- Volcando datos para la tabla adminmuebles.arrendatario: 7 rows
...
INSERT INTO `arrendatario` (`IdArrendatario`, `IdCodeudor`, `NombreCompleto`, `TipoDocumento`, `DocumentoIdentidad`, `Telefono`, `Correo`, `Estado`, `booleanos`) VALUES
	(1, 1, 'Carlos López', 'CC', '111222333', '1112223334', 'carlos@gmail.com', 'Libre', 'true'),
	(2, 2, 'Ana Rodríguez', 'CE', '444555666', '4294967295', 'ana@gmail.com', 'Libre', 'true'),
	(21, NULL, 'HptsPorfin', 'CC', '1192', '4294967295', 'q@q.cos', 'Libre', 'true'),
	(26, NULL, 'Juanda', 'CC', '1234567890', '1234567890', 'nose@gmail.com', 'Libre', 'true'),
	(27, NULL, 'jeison', 'CE', '323232', '1234567890', 'jeison@gmail.com', 'Libre', 'true'),
	(28, NULL, 'juan', 'CC', '25689711', '3132025146', 'hola@gmail.com', 'vigente', 'true'),
	(29, 2, 'manuela', 'CC', '4545445', '3132025146', 'mama@gmail.com', 'Libre', 'true'),
	(30, 3, 'Ramy prueba', 'Cedula Ciudadania', '748747', '425353', 'ramy@gmail.com', 'Libre', 'true');
...
INSERT INTO `codeudor` (`IdCodeudor`, `NombreCompleto`, `TipoDocumento`, `DocumentoIdentidad`, `Telefono`, `Correo`, `Direccion`, `booleanos`) VALUES
	...
	(4, 'Pedro Ramíre', NULL, NULL, NULL, NULL, NULL, 'true');
...
-- Volcando datos para la tabla adminmuebles.comision_propietario: 19 rows
...
-- Volcando datos para la tabla adminmuebles.contratoarrendamiento: 8 rows
...
INSERT INTO `contratoarrendamiento` (`IdContrato`, `IdArrendatario`, `IdInmueble`, `FechaInicioContrato`, `FechaFinContrato`, `EstadoContrato`, `ValorDeposito`, `MesesAlquiler`, `CuotasPendientes`) VALUES
	...
	(3, 2, 9, '2023-12-02', '2024-03-02', 'Finalizado', 25000.00000, 3, 0),
	(4, 2, 18, '2023-12-03', '2024-11-03', 'Vigente', 2500000.00000, 11, 7),
	(5, 2, 20, '2254-05-12', '4444-04-15', 'Vigente', 52000.00000, 26279, 26279),
	(6, 27, 28, '2024-01-01', '2024-08-03', 'Vigente', 2500000.00000, 7, 5),
	(7, 27, 18, '2024-02-26', '2024-04-05', 'Finalizado', 520000.00000, 1, 0),
	(8, 27, 27, '2024-03-09', '2024-10-23', 'Vigente', 300000.00000, 7, 7),
	(9, 2, 24, '2024-02-27', '2024-04-02', 'Finalizado', 90000.00000, 1, 0),
	(10, 30, 24, '2024-02-24', '2024-04-08', 'Finalizado', 600000.00000, 1, 0);
...
-- Volcando datos para la tabla adminmuebles.inmueble: 25 rows
...
INSERT INTO `inmueble` (`IdInmueble`, `IdPropietario`, `NoMatricula`, `Direccion`, `Estrato`, `Ciudad`, `Barrio`, `Tipo`, `NoNiveles`, `NoBanos`, `ServiciosPublicos`, `NoHabitaciones`, `Estado`, `NoTerraza`, `AreaConstruidaM2`, `Aseguramiento`, `ValorInmueble`, `booleanos`, `Descripcion`) VALUES
	(11, 5, 2, 'Holas', '3', 'jhkjhjh', 'si soy', 'Apartamento', '1', '1', 'jhkjhkjhk', NULL, 'Ocupado', '2', NULL, '2024-02-12', 2000, 'true', 'trdfgjkjfdgfgf'),
	(10, 20, 2, '+ñp', '1', '´l+p´+', 'pkk', 'Bodega', NULL, '2', 'p´´pp', NULL, 'Ocupado', NULL, NULL, NULL, 2000, 'true', 'lhjkljkhhj'),
	(1, 1, 12345, 'Calle 456', '4', 'Ciudad A', 'Barrio X', 'Casa', '2', '2', 'Agua, EnergÃ­a', '3', 'Ocupado', '1', '120.5', '2024-03-01', 1500000, 'true', 'Casa de dos pisos'),
	(9, 9, 1, 'kjlkjl', '1', 'kkjl', 'jhkjhk', 'Oficina', NULL, '2', 'cgkjkj', NULL, 'Disponible', NULL, NULL, '2024-03-01', 2000, 'true', 'uiuku'),
	...
	(12, 9, 900, 'fgff', '1', 'fdgfdg', 'dfgfdg', 'Apartamento', '9', '3', 'fgfgfdgfdfdfgfdg', NULL, 'Ocupado', '9', NULL, '2024-02-12', 8000, 'true', 'dfgfgfgf'),
	(13, 8, 900, 'fgff', '8', 'fgfg', 'fhfh', 'Apartamento', '9', '2', 'sd', NULL, 'Ocupado', '6', NULL, '2024-02-12', 700, 'true', 'dfdfdf'),
	(14, 3, 2, 'fdfd', '1', 'palmira', 'fhfh', 'Apartamento', '2', '2', 'fgffgf', NULL, 'Ocupado', '1', NULL, '2024-02-12', 1000000, 'true', '  n n n nvbvbbvbvvb'),
	(15, 3, 896, 'calle #2 cr33', '3', 'palmira', 'dfdfd', 'Apartamento', '2', '9', 'jiisgsdjsdjdjss', NULL, 'Ocupado', '1', NULL, '2024-02-12', 2000, 'true', 'vgygg'),
	(16, 5, 55, 'kj,k,kj,jk,', '4', 'fgfgfd', 'dfgfgfdg', 'Bodega', NULL, '5', 'gfgfgf', NULL, NULL, NULL, NULL, NULL, 20000, 'false', ',k.kl.jk.'),
	(17, 9, 2001, 'carrera 90', '1', 'palmira', 'paraiso', 'Apartamento', '3', '3', 'agua y luz', NULL, NULL, '2', NULL, '2024-02-16', 200000, 'true', 'nada de mascotas'),
	(18, 17, 200089, 'carrera 10 no 3 # 5e98', '4', 'villa hermosda', 'paraiso papa', 'Apartamento', '5', '7', '', NULL, 'Ocupado', '2', NULL, '2024-04-05', 3000000, 'true', 'no se permite perros'),
	...
	(21, 6, 22555, 'carrera nose', '3', 'hila', 'manuel', 'Bodega', NULL, '3', 'gua NOMAS', NULL, 'Disponible', NULL, NULL, NULL, 2500, 'true', 'ggfgfdffdd'),
	(22, 2, 22555, 'carrera nose', '3', 'hila', 'manuel', 'Bodega', NULL, '3', 'gua NOMAS', NULL, 'Disponible', NULL, NULL, NULL, 2500, 'true', 'ggfgfdffdd'),
	(23, 1, 22555, 'carrera nose', '3', 'hila', 'manuel', 'Bodega', NULL, '3', 'gua NOMAS', NULL, 'Disponible', NULL, NULL, NULL, 2500, 'true', 'ggfgfdffdd'),
	...
	(27, 17, 56465, 'carrera alcancela', '1', 'hila', 'encuentrela', 'Oficina', NULL, '7', 'gua NOMAS', NULL, 'Ocupado', NULL, NULL, '2024-03-30', 30000, 'true', 'dfdgfd'),
	...
	(29, 25, NULL, 'Calle 123', '4', 'Ciudad A', 'manuel', 'Apartamento', '2', NULL, 'gua NOMAS', NULL, 'Disponible', '1', NULL, '2024-03-06', 560000, 'true', 'no se permiten mascotas'),
	(30, 25, NULL, 'nose por palmira', '3', 'hila', 'manuel', 'Apartamento', '9', NULL, 'gua NOMAS', NULL, 'Disponible', '7', NULL, '2024-03-07', 60000, 'true', 'jnjknjk'),
	(31, 24, 65498489, 'nose por palmira', '4', 'Ciudad A', 'manuel', 'Oficina', NULL, '9', 'gua NOMAS', NULL, 'Disponible', NULL, NULL, '2024-04-06', 23000, 'true', 'no hay agua');
...
-- Volcando datos para la tabla adminmuebles.pagos_arrendamiento: 35 rows
...
INSERT INTO `pagos_arrendamiento` (`IdPagoArrendamiento`, `IdArrendatario`, `IdContrato`, `FechaPago`, `FechaInicio`, `FechaFin`, `ValorPago`, `FormaPago`, `Estado`, `DiasDMora`, `booleanos`) VALUES
	...
	(16, 2, 4, '2024-03-06', '2222-02-11', '3333-03-11', 3000, 'Efectivo', 'Pagado', NULL, 'true'),
	(17, 2, 4, '2024-03-06', '5555-05-05', '6666-06-06', 300, 'Transferencia', 'Pagado', NULL, 'true'),
	(18, 2, 4, '2024-03-06', '6666-06-06', '5555-05-05', 99999, 'Efectivo', 'Pagado', NULL, 'true'),
	(19, 2, 4, '2024-03-06', '2222-02-22', '4444-04-04', 65444, 'Efectivo', 'Pagado', NULL, 'true'),
	(20, 2, 4, '2024-03-06', '5555-05-25', '2025-01-06', 65656, 'Efectivo', 'Pagado', NULL, 'true'),
	(21, 2, 4, '2024-03-06', '5555-05-25', '2025-01-06', 65656, 'Efectivo', 'Pagado', NULL, 'true'),
	(22, 2, 4, '2024-03-06', '5555-05-25', '2025-01-06', 65656, 'Efectivo', 'Pagado', NULL, 'true'),
	(23, 2, 3, '2024-03-06', '2024-02-27', '2024-04-05', 25000, 'Transferencia', 'Pagado', NULL, 'true'),
	(24, 2, 3, '2024-03-06', '2024-02-27', '2024-03-30', 26000, 'Transferencia', 'Pagado', NULL, 'true'),
	(25, 2, 3, '2024-03-06', '2024-02-28', '2024-04-04', 36000, 'Efectivo', 'Pagado', NULL, 'true'),
	(26, 2, 3, '2024-03-06', '2024-02-29', '2024-03-28', 6000, 'Efectivo', 'Pagado', NULL, 'true'),
	(27, 2, 3, '2024-03-06', '2222-02-12', '3333-03-23', 20, 'Efectivo', 'Pagado', NULL, 'true'),
	(28, 2, 3, '2024-03-06', '5555-05-05', '3333-03-31', 36000, 'Efectivo', 'Pagado', NULL, 'true'),
	(29, 27, 6, '2024-03-06', '2024-02-29', '2024-04-04', 560000, 'Efectivo', 'Pagado', NULL, 'true'),
	(30, 27, 7, '2024-03-06', '2024-03-04', '2024-03-29', 5000, 'Efectivo', 'Pagado', NULL, 'true'),
	(31, 2, 4, '2024-03-07', '2024-02-25', '2024-03-21', 500000, 'Transferencia', 'Pagado', -14, 'true'),
	(32, 2, 4, '2024-03-07', '2023-12-12', '2024-02-25', 30000, 'Efectivo', 'Pagado', 11, 'true'),
	(33, 27, 6, '2024-03-07', '2024-02-25', '2024-03-01', 30000, 'Efectivo', 'Pagado', 6, 'true'),
	(34, 2, 4, '2024-03-07', '2023-02-28', '2029-10-06', 65562, 'Transferencia', 'Pagado', -2039, 'true'),
	(35, 2, 4, '2024-03-07', '2005-02-25', '2020-02-29', 900000, 'Efectivo', 'Pagado', 1468, 'true'),
	(36, 2, 9, '2024-03-10', NULL, '2024-04-06', 5000000, 'Efectivo', 'Pagado', -27, 'true'),
	(37, 30, 10, '2024-03-10', NULL, '2024-04-04', 7000000, 'Efectivo', 'Pagado', -25, 'true');
...
-- Volcando datos para la tabla adminmuebles.propietario: 20 rows
...
INSERT INTO `propietario` (`IdPropietario`, `NombreCompleto`, `TipoDocumento`, `DocumentoIdentidad`, `Direccion`, `Telefono`, `Correo`, `Banco`, `TipoCuenta`, `NumeroCuenta`, `booleanos`, `FechaIngreso`) VALUES
	...
	(25, 'Yeison waldir', 'Cedula Ciudadania', '25689711', 'nose por palmira', '', '', 'av villa', 'Cuenta Ahorros', '2500265', 'true', '2024-03-06');
...
-- Volcando datos para la tabla adminmuebles.trabajador: 3 rows
...
-- Volcando estructura para disparador adminmuebles.after_update_contrato
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE TRIGGER `after_update_contrato` AFTER UPDATE ON `contratoarrendamiento` FOR EACH ROW BEGIN
...
-- Volcando estructura para disparador adminmuebles.after_update_contratoarrendamiento
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE TRIGGER `after_update_contratoarrendamiento` AFTER UPDATE ON `contratoarrendamiento` FOR EACH ROW BEGIN
    IF NEW.EstadoContrato = 'Finalizado' THEN
        UPDATE inmueble
...
CREATE TRIGGER `Before_Insert_PagosArrendamiento` BEFORE INSERT ON `pagos_arrendamiento` FOR EACH ROW BEGIN
    ...
    SET NEW.DiasDMora = DATEDIFF(NEW.FechaPago, NEW.FechaFin);
END//
DELIMITER ;
SET SQL_MODE=@OLDTMP_SQL_MODE;
