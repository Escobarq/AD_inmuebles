...
-- Volcando datos para la tabla adminmuebles.contratoarrendamiento: 46 rows
...
INSERT INTO `contratoarrendamiento` (`IdContrato`, `IdArrendatario`, `IdInmueble`, `FechaInicioContrato`, `FechaFinContrato`, `EstadoContrato`, `ValorDeposito`, `MesesAlquiler`, `CuotasPendientes`, `FechaPagoFija`) VALUES
	...
	(39, 30, 34, '2024-03-18', '2025-03-17', 'Finalizado', 50000.00000, 12, 0, '2024-03-18'),
	...
	(47, 26, 34, '2024-04-01', '2025-03-31', 'Vigente', 1500.00000, 12, 12, '2024-04-01');
...
-- Volcando datos para la tabla adminmuebles.pagos_arrendamiento: 224 rows
...
INSERT INTO `pagos_arrendamiento` (`IdPagoArrendamiento`, `IdArrendatario`, `IdContrato`, `FechaPago`, `FechaPagoFija`, `ValorPago`, `FormaPago`, `Estado`, `DiasDMora`, `booleanos`) VALUES
	...
	(147, 30, 39, '2024-04-01', '2024-03-18', 3000, 'Efectivo', 'Atrasado', 14, 'true'),
	(148, 30, 39, '2024-04-01', '2024-04-18', 3000, 'Efectivo', 'Adelantado', -17, 'true'),
	(149, 30, 39, '2024-04-01', '2024-05-18', 3000, 'Efectivo', 'Adelantado', -47, 'true'),
	(150, 30, 39, '2024-04-01', '2024-06-18', 3000, 'Efectivo', 'Adelantado', -78, 'true'),
	(151, 30, 39, '2024-04-01', '2024-07-18', 3000, 'Efectivo', 'Adelantado', -108, 'true'),
	(152, 30, 39, '2024-04-01', '2024-08-18', 3000, 'Efectivo', 'Adelantado', -139, 'true'),
	(153, 30, 39, '2024-04-01', '2024-09-18', 3000, 'Efectivo', 'Adelantado', -170, 'true'),
	(154, 30, 39, '2024-04-01', '2024-10-18', 3000, 'Efectivo', 'Adelantado', -200, 'true'),
	(155, 30, 39, '2024-04-01', '2024-11-18', 3000, 'Efectivo', 'Adelantado', -231, 'true'),
	(156, 30, 39, '2024-04-01', '2024-12-18', 3000, 'Efectivo', 'Adelantado', -261, 'true'),
	(157, 30, 39, '2024-04-01', '2025-01-18', 3000, 'Efectivo', 'Adelantado', -292, 'true'),
	...
	(243, 26, 47, NULL, '2024-04-01', 0, 'Pendiente', 'Pendiente', NULL, 'true'),
	(244, 26, 47, NULL, '2024-05-01', 0, 'Pendiente', 'Pendiente', NULL, 'true'),
	(245, 26, 47, NULL, '2024-06-01', 0, 'Pendiente', 'Pendiente', NULL, 'true'),
	(246, 26, 47, NULL, '2024-07-01', 0, 'Pendiente', 'Pendiente', NULL, 'true'),
	(247, 26, 47, NULL, '2024-08-01', 0, 'Pendiente', 'Pendiente', NULL, 'true'),
	(248, 26, 47, NULL, '2024-09-01', 0, 'Pendiente', 'Pendiente', NULL, 'true'),
	(249, 26, 47, NULL, '2024-10-01', 0, 'Pendiente', 'Pendiente', NULL, 'true'),
	(250, 26, 47, NULL, '2024-11-01', 0, 'Pendiente', 'Pendiente', NULL, 'true'),
	(251, 26, 47, NULL, '2024-12-01', 0, 'Pendiente', 'Pendiente', NULL, 'true'),
	(252, 26, 47, NULL, '2025-01-01', 0, 'Pendiente', 'Pendiente', NULL, 'true'),
	(253, 26, 47, NULL, '2025-02-01', 0, 'Pendiente', 'Pendiente', NULL, 'true'),
	(254, 26, 47, NULL, '2025-03-01', 0, 'Pendiente', 'Pendiente', NULL, 'true');
...
-- Volcando datos para la tabla adminmuebles.trabajador: 5 rows
/*!40000 ALTER TABLE `trabajador` DISABLE KEYS */;
INSERT INTO `trabajador` (`IdTrabajador`, `Nombre`, `Apellido`, `Correo`, `Contrasena`, `Telefono`, `Idrol`, `Booleanos`) VALUES
	(1, 'Juan', 'Pérez', 'juan@example.com', '$2a$10$KMrlumtNCNQUHAd6G.4MYu4WfevzdmVJ2zq./l7674wj/O83sVGZW', '555-1234', 1, 'true'),
	(2, 'María Sambranos', 'Gómez  Peña', 'maria@example.com', '$2a$10$Ju0gJ80WAZp6zZJBWFnxD.GixEkdfd0LwKpaiMKUxP5vERv/zwqB6', '3158763654', 1, 'true'),
	(6, 'luis', 'Martinez', 'ramy@gmail.com', '$2a$10$gFPS/cvwLIVBHbuj1AjPY.ewHxJxkpP.8RpUTjFhkNFJG8ElSRcXe', '3132025146', 2, 'true'),
	(7, 'Emanuel', 'Vergara', 'emanuel@gmail.com', '$2a$10$cXT6yclnwjlw3S3rHMdMXeGpTwjdqOlJziWSYybcYHr.tFpUfDQnG', '541495', 2, 'true'),
	(8, 'Super ', 'Usuario', 'superusuario@outlook.com', '$2a$10$X6LvBAtdSdVqksG/g15BvOo/R7eyz5klUTsJ475LVgxOF90Vl1lKq', '3225445717', 3, 'true');
