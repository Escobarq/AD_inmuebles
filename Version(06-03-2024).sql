...
-- Volcando datos para la tabla adminmuebles.comision_propietario: 11 rows
...
-- Volcando datos para la tabla adminmuebles.pagos_arrendamiento: 15 rows
...
-- Volcando datos para la tabla adminmuebles.propietario: 19 rows
