        ...
        <div className="home-2">
                ...
                <form className='tod'>
                    ...
                    <div className="fila-formulario">
                        <div className="grupo-formulario">
                            ...
                            <select  id="seleccionGasto1" value={formData.seleccionGasto1} onChange={handleInputChange}>
                                <option value="">Seleccione una opción</option>
                                <option value="Pago arriendo mes">Pago arriendo mes</option>
                                <option value="Administración inmobiliaria">Administración inmobiliaria</option>
                                <option value="Aseo entrega casa">Aseo entrega casa</option>
                            ...
                            <select  id="seleccionGasto2" value={formData.seleccionGasto2} onChange={handleInputChange}>
                                <option value="">Seleccione una opción</option>
                                <option value="Pago arriendo mes">Pago arriendo mes</option>
                                <option value="Administración inmobiliaria">Administración inmobiliaria</option>
                                <option value="Aseo entrega casa">Aseo entrega casa</option>
                            ...
                            <select  id="seleccionGasto3" value={formData.seleccionGasto3} onChange={handleInputChange}>
                                <option value="">Seleccione una opción</option>
                                <option value="Pago arriendo mes">Pago arriendo mes</option>
                                <option value="Administración inmobiliaria">Administración inmobiliaria</option>
                                <option value="Aseo entrega casa">Aseo entrega casa</option>
            ...
            <div className="btns">
                <button className=' guardar' onClick={handleSave}>
                    <FontAwesomeIcon icon={faSave} className='icon-btn'/>
                    Generar recibo
                </button>
                <button className='btn btn-cancelar cancelar-btn' onClick={handleCancel}>
